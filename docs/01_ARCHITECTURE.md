...
参考 ARIS 的对抗性交叉模型协作、PaperOrchestra 的多 Agent 管道，以及真实顶会的多审稿人制度，AutoPaper 采用 **三层 Critic 架构**：
...
| 特性 | AutoPaper | ARIS | PaperOrchestra | AutoResearchClaw | ai-research-skills |
|------|---------------|------|----------------|------------------|-------------------|
...
AutoPaper 不是闭门造车，而是积极吸收现有成熟工作流的核心优势，将其适配到我们的 36-Stage + 3-Layer Critic 框架中。
...
AutoPaper 使用原生 subagent 策略进行多 Agent 调度。
